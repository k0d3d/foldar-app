...
import { FullPageErrorFallback } from "../jsx/components/lib";
...
export interface ServiceProviderError extends Error {
  "message": string,
  "response"?: {
    "data": {
      "url": string,
 ...
 * @param error 
 */
export function handleRemoteOperationError(error: ServiceProviderError, options? : {message: string} ) {
